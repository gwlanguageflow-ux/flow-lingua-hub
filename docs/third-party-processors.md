...
| Stripe                        | Provedor legado desativado                                 | Registros historicos de assinaturas criadas antes da migracao                                    | Historico financeiro                               | `src/routes/api/public/stripe-webhook.ts` responde sem processar eventos                                                                             | Nao usado em novos pagamentos/saques                                       | Sem SDK ativo; rota antiga nao altera banco                               |
| Asaas                         | Provedor legado desativado                                 | Registros historicos de tentativas de saque                                                      | Historico operacional                              | `src/routes/api/public/asaas-webhook.ts` responde sem processar eventos                                                                              | Nao usado em novos pagamentos/saques                                       | Rota antiga nao altera banco                                              |
...
- Webhooks ativos devem continuar usando assinatura: ValidaPay usa `VALIDAPAY_WEBHOOK_SECRET` com o header `x-webhook-signature`.
